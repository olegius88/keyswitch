...
[0.25.2](https://github.com/olegius88/keyswitch/releases/tag/v0.25.2).
...
Download `KeySwitch-Setup-0.25.2-x64.exe` from the
[published 0.25.2 release](https://github.com/olegius88/keyswitch/releases/tag/v0.25.2) and run
...
portable `KeySwitch-0.25.2-windows-x64.zip` archive.
...
Download `keyswitch_0.25.2_amd64.deb` from the
[published 0.25.2 release](https://github.com/olegius88/keyswitch/releases/tag/v0.25.2), then
install it with:

```bash
sudo apt install ./keyswitch_0.25.2_amd64.deb
```
...
- The published Windows 0.25.2 Setup EXE is not signed with a publisher certificate.

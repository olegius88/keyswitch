...
Download `KeySwitch-Setup-0.11.2-x64.exe` from the
...
portable `KeySwitch-0.11.2-windows-x64.zip` archive.
...
Download `keyswitch_0.11.2_amd64.deb` from the
...
- The Windows 0.11.2 Setup EXE is not yet signed with a publisher certificate.

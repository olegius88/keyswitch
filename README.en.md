...
Download `KeySwitch-Setup-0.10.0-x64.exe` from the
...
portable `KeySwitch-0.10.0-windows-x64.zip` archive.
...
Download `keyswitch_0.10.0_amd64.deb` from the
...
- The Windows 0.10.0 Setup EXE is not yet signed with a publisher certificate.

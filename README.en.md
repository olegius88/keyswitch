...
[0.26.1](https://github.com/olegius88/keyswitch/releases/tag/v0.26.1).
...
Download `KeySwitch-Setup-0.26.1-x64.exe` from the
[published 0.26.1 release](https://github.com/olegius88/keyswitch/releases/tag/v0.26.1) and run
...
portable `KeySwitch-0.26.1-windows-x64.zip` archive.
...
Download `keyswitch_0.26.1_amd64.deb` from the
[published 0.26.1 release](https://github.com/olegius88/keyswitch/releases/tag/v0.26.1), then
install it with:

```bash
sudo apt install ./keyswitch_0.26.1_amd64.deb
```
...
- The published Windows 0.26.1 Setup EXE is not signed with a publisher certificate.

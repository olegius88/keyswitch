...
[0.26.0](https://github.com/olegius88/keyswitch/releases/tag/v0.26.0).
...
Download `KeySwitch-Setup-0.26.0-x64.exe` from the
[published 0.26.0 release](https://github.com/olegius88/keyswitch/releases/tag/v0.26.0) and run
...
portable `KeySwitch-0.26.0-windows-x64.zip` archive.
...
Download `keyswitch_0.26.0_amd64.deb` from the
[published 0.26.0 release](https://github.com/olegius88/keyswitch/releases/tag/v0.26.0), then
install it with:

```bash
sudo apt install ./keyswitch_0.26.0_amd64.deb
```
...
- The published Windows 0.26.0 Setup EXE is not signed with a publisher certificate.

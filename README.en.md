...
Download `KeySwitch-Setup-0.9.1-x64.exe` from the
...
portable `KeySwitch-0.9.1-windows-x64.zip` archive.
...
Download `keyswitch_0.9.1_amd64.deb` from the
...
- The Windows 0.9.1 Setup EXE is not yet signed with a publisher certificate.

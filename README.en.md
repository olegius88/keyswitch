...
Download `KeySwitch-Setup-0.31.0-x64.exe` from the
[published 0.31.0 release](https://github.com/olegius88/keyswitch/releases/tag/v0.31.0) and run
...
portable `KeySwitch-0.31.0-windows-x64.zip` archive.
...
Download `keyswitch_0.31.0_amd64.deb` from the
[published 0.31.0 release](https://github.com/olegius88/keyswitch/releases/tag/v0.31.0), then
install it with:
...
- The published Windows 0.31.0 Setup EXE is not signed with a publisher certificate.

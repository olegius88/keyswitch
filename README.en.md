...
[0.24.0](https://github.com/olegius88/keyswitch/releases/tag/v0.24.0).
...
Download `KeySwitch-Setup-0.24.0-x64.exe` from the
[published 0.24.0 release](https://github.com/olegius88/keyswitch/releases/tag/v0.24.0) and run
...
portable `KeySwitch-0.24.0-windows-x64.zip` archive.
...
Download `keyswitch_0.24.0_amd64.deb` from the
[published 0.24.0 release](https://github.com/olegius88/keyswitch/releases/tag/v0.24.0), then
install it with:

```bash
sudo apt install ./keyswitch_0.24.0_amd64.deb
```
...
- The published Windows 0.24.0 Setup EXE is not signed with a publisher certificate.

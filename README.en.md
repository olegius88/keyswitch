...
Download `KeySwitch-Setup-0.11.1-x64.exe` from the
...
portable `KeySwitch-0.11.1-windows-x64.zip` archive.
...
Download `keyswitch_0.11.1_amd64.deb` from the
...
- The Windows 0.11.1 Setup EXE is not yet signed with a publisher certificate.
